...
uint32_t akmsC0[8] = {0xd419dd28, 0xe2be508d, 0xc7d77bcd, 0xf92730ad, 0xba943336, 0xd9700b94, 0xe89147b7, 0xd835c940};
...
void akmsgenRoundKeys(struct akmsState * state, unsigned char * key, int keylen) {
    ...
    kstate.r[8] = akmsC0[0];
    kstate.r[9] = akmsC0[1];
    kstate.r[10] = akmsC0[2];
    kstate.r[11] = akmsC0[3];
    kstate.r[12] = akmsC0[4];
    kstate.r[13] = akmsC0[5];
    kstate.r[14] = akmsC0[6];
    kstate.r[15] = akmsC0[7];
